...
std::shared_ptr<SDL_Surface> reverseLoadSurface(const std::string &filepath) {
...
namespace Util {
reverseImage::reverseImage(const std::string &filepath)
    : m_Path(filepath) {
...
void reverseImage::SetNImage(const std::string &filepath) {
    auto surface = s_Store.Get(filepath);
...
void reverseImage::Draw(const Core::Matrices &data) {
...
void reverseImage::InitVertexArray() {
...
std::unique_ptr<Core::Program> reverseImage::s_Program = nullptr;
std::unique_ptr<Core::VertexArray> reverseImage::s_VertexArray = nullptr;

Util::AssetStore<std::shared_ptr<SDL_Surface>> reverseImage::s_Store(reverseLoadSurface);
} // namespace Util
