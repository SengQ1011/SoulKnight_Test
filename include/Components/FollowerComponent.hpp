...
public:
	explicit FollowerComponent(const glm::vec2& handOffset = glm::vec2(0, 0),
		...
		m_HandOffset(handOffset), m_HoldingOffset(holdingOffset), m_HoldingRotation(holdingRotation),
		m_UseMousePosition(isTargetMouse),m_Follower(follower),m_Target(target) {}
