...
public:
	...
	explicit Character(const std::string& ImagePath, int maxHp,float moveSpeed, int aimRange, std::unique_ptr<CollisionBox> collisionBox, std::unique_ptr<Weapon> initialWeapon);
