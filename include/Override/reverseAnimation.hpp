...
#ifndef REVERSEANIMATION_HPP
#define REVERSEANIMATION_HPP
 ...
 */
class reverseAnimation : public Core::Drawable {
public:
    /**
     ...
     * restart.
     */
    reverseAnimation(const std::vector<std::string> &paths, bool play,
...
private:
    std::vector<std::shared_ptr<Util::reverseImage>> m_Frames;
    State m_State;
    double m_Interval;
    bool m_Looping;
