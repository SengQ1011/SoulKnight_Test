...
#ifndef REVERSEIMAGE_HPP
#define REVERSEIMAGE_HPP
 ...
 */
class reverseImage : public Core::Drawable {
public:
    /**
     ...
     */
    explicit reverseImage(const std::string &filepath);
     ...
     * @param filepath The file path to the image.
     */
    void SetNImage(const std::string &filepath);
